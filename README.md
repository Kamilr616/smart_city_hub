...
- Node.js 18+ and npm
- A MongoDB Atlas account (or a local MongoDB replica set; user-management updates use transactions)
...
The panel retains the original white/gray palette, blue navigation, black buttons, and KI logo, with concise functional headings. New passwords require at least 12 characters and at most 72 UTF-8 bytes. An administrator cannot deactivate their own account or remove their own administrator access; the last active administrator is protected.
...
| **Marcin Golonka** ([@Golonka-Ma](https://github.com/Golonka-Ma), [LinkedIn](https://www.linkedin.com/in/marcin-golonka-4510a928b/)) | React Native prototype author |
