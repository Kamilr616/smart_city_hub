...
const AdminsTable = () => {
  ...
  }, [user?.token, fetchDevices, fetchStates]);
        ...
        {loading ? (
          ...
          <table className="border-collapse w-3/4 mx-auto border border-gray-200 px-2 py-4 mt-2">
            ...
            <tbody>
              {devices?.map((device) => {
                return (
                  <tr key={device.deviceId} className="bg-white lg:hover:bg-gray-100 flex lg:table-row flex-row lg:flex-row flex-wrap lg:flex-no-wrap mb-10 lg:mb-0">
                    ...
                    <td className="w-full lg:w-auto p-3 text-gray-800 text-center  border-b border-gray-200  block lg:table-cell relative lg:static">
                      <span
                        onClick={() =>
                          updateState(
                            device.deviceId,
                            Boolean(deviceStatus[device.deviceId])
                          )
                        }
                        className={`${
